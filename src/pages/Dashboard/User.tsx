...
//           <span className="w-[68px] block text-center py-1 border border-green-500 text-green-600 rounded text-xs">Active</span>
//         </td>
//         <td className="p-4 text-sm text-black">
//           2023-07-01
//         </td>
...
//             </svg>
//           </button>
//           <button title="View" className="ml-4">
//             <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-blue-500 hover:fill-blue-700" viewBox="0 0 24 24">
...
const User: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 bg-gray-100 text-gray-800">
      <h1 className="text-2xl font-bold mb-4 pt-4">User Profiles</h1>
      {users.length > 0 ? (
        ...
        <p className="py-4 text-gray-600">No user data found or unauthorized access.</p>
      )}
    </div>
  );
};
