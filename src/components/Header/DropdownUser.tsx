    ...
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      >
        <div className="relative">
          <span className="h-12 w-12 rounded-full p-1 block" style={{
            background: 'linear-gradient(45deg, #ff00ff, #00ffff)',
          }}>
            <img src={userImage} alt="User" className="rounded-full w-full h-full object-cover" />
          </span>
          <span className="absolute -bottom-3 left-0 text-xs font-medium text-black dark:text-white bg-yellow-100 dark:bg-yellow-800 px-2 py-1 rounded-full">
            {username}
          </span>
        </div>
